...
`0.1.0` is an alpha release. Test it in a non-production Open edX environment
before enabling it on a live course.

## Requirements

- Python 3.12 or later
- An Open edX deployment that can install `XBlock>=6,<7`
...
```sh
tutor config save --append OPENEDX_EXTRA_PIP_REQUIREMENTS=scaffold-xblock==0.1.0
...
Each command must report `Version: 0.1.0`.
...
```sh
python -m pip install "scaffold-xblock==0.1.0"
...
[versioned GitHub Release](https://github.com/brainjamworks/scaffold/releases/tag/v0.1.0);
