...
export default defineConfig({
  ...
  run: {
    tasks: {
      ...
      "verify:tooling":
        "vp exec node --test scripts/dependency-cruiser.test.mjs scripts/repository-metadata.test.mjs scripts/create-block.test.mjs scripts/create-layout.test.mjs scripts/prepare-release-candidate.test.mjs scripts/publish-pypi-workflow.test.mjs scripts/release-workflow.test.mjs",
