...
function registration(authoredBlockId: string, targetId: string): AssessmentRegistrationInput {
  return {
    authoredBlockId,
    targetId,
...
function identity(authoredBlockId: string, targetId: string): AssessmentRegistrationIdentity {
  return {
    authoredBlockId,
    targetId,
    interactionKind: "single-select",
