import type { LineChartEncoding } from "@/schemas/shared";
...
export const lineChartProfile: ChartProfile<LineChartEncoding> = {
  chartType: "line",
  ...
  compile(chart, encoding) {
    ...
    return {
      ...
      series: yColumns.map((column) => ({
        ...
        areaStyle: encoding.area || encoding.stacked ? { opacity: 0.12 } : undefined,
      })),
    };
  },
